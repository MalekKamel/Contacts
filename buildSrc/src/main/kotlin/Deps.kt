...
object Deps {
    ...
    const val androidx_lifeCycleCommonJava8 =
    ...
    const val androidx_ViewModelExt =
        "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.androidx_ViewModelExt}"
    ...
    const val rx_lifeCycleComponent =
        "com.trello.rxlifecycle2:rxlifecycle-components:${Versions.rx_lifeCycleComponent}"
    const val rx_permissions = "com.github.tbruyelle:rxpermissions:${Versions.rx_permissions}"

    const val materialDesign = "com.google.android.material:material:${Versions.materialDesign}"

    // Shaban kamel
    const val sha_formValidator =
        "com.github.ShabanKamell:FormValidator:${Versions.sha_formValidator}"
    const val sha_formValidator_core =
        "com.github.ShabanKamell.FormValidator:core:${Versions.sha_formValidator}"
    const val sha_formValidator_rx =
        "com.github.ShabanKamell.FormValidator:rxjava:${Versions.sha_formValidator}"
    ...
    const val sha_coroutineRequester =
        "com.github.ShabanKamell:CoroutineRequester:${Versions.sha_coroutineRequester}"
...
object TestDeps {
    ...
    const val kotlinTestJunit5 =
        "io.kotlintest:kotlintest-runner-junit5:${TestVersions.test_kotlinTestJunit5}"
    const val kotlinTestExtKoin =
        "io.kotlintest:kotlintest-extensions-koin:${TestVersions.test_kotlinTestExtKoin}"
